...
void tall_window_block(int front, int left, int right, int back){
   if(back == 1){
      wall_with_tall_grade_window(0,0,-base,0,0,0,0);
      aux_wall_tall_grade_window(0,0,wall_thickness-base,0,0,0,0);
      wall_fill(base-wall_thickness,0,0,90,0,1,0);
      wall_fill(base-wall_thickness,0,base,90,0,1,0);
   }
   if(right == 1){
   ...
   if(front == 1){
      wall_with_tall_grade_window(0,0,0,0,0,0,0);
      aux_wall_tall_grade_window(0,0,wall_thickness,0,0,0,0);
      wall_fill(-wall_thickness,0,0,90,0,1,0);
      wall_fill(-wall_thickness,0,base,90,0,1,0);
   }
   if(left == 1){
...
void front_door_block(const Door *d, int front, int left, int right, int back){
   ...
   if(right == -1){
      wall_with_door(d,-base,0,base,180,0,1,0);
      wall_fill(0,0,-wall_thickness,0,0,0,0);
   }
   if(front == 1){
...
void lateral_door_block(const Door *d, int front, int left, int right, int back){
   ...
   if(right == -1){
      wall_with_door(d,0,0,0,90,0,1,0);
      aux_wall_door(-base-wall_thickness,0,-wall_thickness,90,0,1,0);
      wall_fill(0,0,-wall_thickness,0,0,0,0);
   }
   if(front == 1){
      wall(0,0,0,0,0,0,0);
   ...
   if(left == -1){
      wall_with_door(d,0,0,base+0.15,90,0,1,0);
   }
   if(left == 1){
