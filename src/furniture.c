...
void primeiro_andar_moveis()
{
    ...
    glTranslatef(base * 5.6, 30, base * 3.5);
    glRotatef(180, 0, 1, 0);
    glScalef(2, 1, 1);
    placa_azul();
    glPopMatrix();
...
void cabine_recepção()
{
    ...
    glColor4f(0.8, 0.9, 1, 0.4);
        glTranslatef(base * 5, (base + betw_height) + 35, base * 3);
    glScalef(85, 20, 0.5);
    drawCubeUnit();
    glPopMatrix();
}
...
void draw_lightning()
{
    ...
    glVertex2f(1.2, 1.91);
    glVertex2f(0.18f, 1.67f);
    glVertex2f(-0.82f, -0.09f);
    glVertex2f(-0.25, 0.02f);
    glVertex2f(-1.05, -1.32);
    glVertex2f(-0.43, -1.21);

    glVertex2f(-1.08, -2.46);

    glVertex2f(0.64, -0.8);
    glVertex2f(-0.08, -0.97);
    glVertex2f(0.9, 0.56);
...
void mobilia_recepcao()
{
    ...
    glPushMatrix();
    glTranslatef(2.4 * base, (base + betw_height) + 20, 2.5 * base);
    glScalef(5, 7, 5);
    famele();
    glPopMatrix();

    glPushMatrix();
    glTranslatef(2.9 * base, (base + betw_height) + 25, 2.5 * base);
    glRotatef(180, 0, 1, 0);
    glScalef(4, 8, 4);
    male();
    glPopMatrix();
    ...
    glPopMatrix();
        ...
        // placa acima da cadeira
    glPushMatrix();
    glTranslatef(2.70 * base, (base + betw_height) + 30, 2.05 * base);
    glScalef(2, 1, 1);
    placa_azul();
    glPopMatrix();
    ...
    glPushMatrix();
    glTranslatef(7.5 * base, (base + betw_height), 3.35 * base);
    glScalef(20, 20, 20);
    glRotatef(180, 0, 1, 0);
    bancoEspera_draw();
    glPopMatrix();
        ...
        // extintor
    glPushMatrix();
    glTranslatef(7.40 * base, (base + betw_height) + 30, -1+3.5 * base);
    glScalef(2, 3, 2);
    extintor();
    glPopMatrix();

    glPushMatrix();
    glTranslatef(base * 3.7, (base + betw_height) + 30, -1+base * 3.5);
    glScalef(2, 3, 2);
    extintor();
    glPopMatrix();
    ...
    glPushMatrix();
    black;
    glTranslatef(3 * base, (base + betw_height) + (ground_offset - 1.9), 3.40 * base);
    cesto_draw();
    glPopMatrix();
    ...
    glPushMatrix();
    red;
    glTranslatef(6.3 * base, (base + betw_height) + (5 * ground_offset), 3.50 * base);
    glRotatef(90, 0, 1, 0);
    glScalef(1, 4, 4);
    drawCube(1, 5, 5);
    glPopMatrix();
    ...
    glPushMatrix();
    red;
    glTranslatef(6.7 * base, (base + betw_height)+ (5 * ground_offset), -1+3.50 * base);
    glRotatef(90, 0, 1, 0);
    glScalef(1, 6, 2);
    drawCube(1, 5, 5);
    glPopMatrix();
     ...
     // Raio
    glPushMatrix();
    glTranslatef(6.7 * base, (base + betw_height) + (5 * ground_offset), -1+3.489 * base);
    glScalef(2, 2, 2);
    draw_lightning();
    glPopMatrix();
    ...
    glPushMatrix();
    red;
    glTranslatef(-2+7 * base, (base + betw_height) + (5 * ground_offset), -1+3.50 * base);
    glRotatef(90, 0, 1, 0);
    glScalef(1, 3, 3);
    drawCube(1, 5, 5);
    glPopMatrix();
    ...
    // raio
    glPushMatrix();
    glTranslatef(7 * base, (base + betw_height) + (5 * ground_offset), -1+3.489 * base);
    glScalef(2, 2, 2);
    draw_lightning();
    glPopMatrix();
    ...
    glPushMatrix();
    red;
    glTranslatef(-2+3 * base, (base + betw_height) + (5 * ground_offset), -5+3.5 * base);
    glRotatef(90, 0, 1, 0);
    glScalef(1, 5, 3);
    drawCube(1, 5, 5);
    glPopMatrix();
      ...
      // raio
    glPushMatrix();
    glTranslatef(3 * base, (base + betw_height) + (5 * ground_offset), -5+3.489 * base);
    glScalef(2, 2, 2);
    draw_lightning();
    glPopMatrix();
...
void mobilia_banheiros()
{
    ...
    glPushMatrix();
    white_shadow;
    glTranslatef(2.80 * base, (base + betw_height) + 25, 5.20 * base);
    glScalef(1, 50, 20);
    drawCubeUnit();
    glPopMatrix();
    ...
    glPushMatrix();
    white_shadow;
    glTranslatef(2.80 * base, (base + betw_height) + 25, 6.80 * base);
    glScalef(1, 50, 20);
    drawCubeUnit();
    glPopMatrix();
    ...
    glPushMatrix();
    white_shadow;
    glTranslatef(7.20 * base, (base + betw_height) + 25, 5.20 * base);
    glScalef(1, 50, 20);
    drawCubeUnit();
    glPopMatrix();
    ...
    glPushMatrix();
    white_shadow;
    glTranslatef(7.20 * base, (base + betw_height) + 25, 6.80 * base);
    glScalef(1, 50, 20);
    drawCubeUnit();
    glPopMatrix();
}
...
void mobilia_salas()
{
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        // Pcs
        glPushMatrix();
        glTranslatef(0.15 * base, (base + betw_height) + 18.5, (-0.45 + i) * base);
        glRotatef(-135, 0, 1, 0);
        glScalef(10, 10, 10);
        monitor_draw();
        glPopMatrix();
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        // Pcs
        glPushMatrix();
        glTranslatef(2.85 * base, (base + betw_height) + 18.5, (-0.50 + i) * base);
        glRotatef(45, 0, 1, 0);
        glScalef(10, 10, 10);
        monitor_draw();
        glPopMatrix();
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        // Pcs
        glPushMatrix();
        glTranslatef(9.85 * base, (base + betw_height) + 18.5, (-0.50 + i) * base);
        glRotatef(45, 0, 1, 0);
        glScalef(10, 10, 10);
        monitor_draw();
        glPopMatrix();
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        // Pcs
        glPushMatrix();
        glTranslatef(7.15 * base, (base + betw_height) + 18.5, (-0.45 + i) * base);
        glRotatef(-135, 0, 1, 0);
        glScalef(10, 10, 10);
        monitor_draw();
        glPopMatrix();
