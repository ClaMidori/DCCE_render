...
void lateral_wood_door_block(int front, int left, int right, int back){
   ...
   if(right == 1){
      wall_with_wood_door(-base,0,0,270,0,1,0);
      aux_wall_wood_door(-base,0,-wall_thickness,270,0,1,0);
      wall_fill(0,0,-base,0,0,0,0);
      wall_fill(0,0,0,0,0,0,0);
      wall_fill(0,0,-base/2+wall_thickness,0,0,0,0);
      wall_fill(0,0,-base+wall_thickness,0,0,0,0);
   ...
   if(left == 1){
      wall_with_wood_door(0,0,base,90,0,1,0);
      aux_wall_wood_door(0,0,base-wall_thickness,90,0,1,0);
      wall_fill(base-wall_thickness,0,-base,0,0,0,0);
      wall_fill(base-wall_thickness,0,0,0,0,0,0);
   }
}
