...
void mobilia_recepcao()
{
    ...
    // extintor
    glPushMatrix();
    glTranslatef(7.40 * base, (base + betw_height) + 30, 3.5 * base);
    glScalef(2, 3, 2);
    extintor();
    glPopMatrix();

    glPushMatrix();
    glTranslatef(base * 3.7, (base + betw_height) + 30, base * 3.5);
    glScalef(2, 3, 2);
    extintor();
    glPopMatrix();
    ...
    glPushMatrix();
    red;
    glTranslatef(6.7 * base, (base + betw_height) + (5 * ground_offset), 3.50 * base);
    glRotatef(90, 0, 1, 0);
    glScalef(1, 6, 2);
    drawCube(1, 5, 5);
    glPopMatrix();
    ...
    // Raio
    glPushMatrix();
    glTranslatef(6.7 * base, (base + betw_height) + (5 * ground_offset), 3.489 * base);
    glScalef(2, 2, 2);
    draw_lightning();
    glPopMatrix();
    ...
    glPushMatrix();
    red;
    glTranslatef(7 * base, (base + betw_height) + (5 * ground_offset), 3.50 * base);
    glRotatef(90, 0, 1, 0);
    glScalef(1, 3, 3);
    drawCube(1, 5, 5);
    glPopMatrix();
    ...
    // raio
    glPushMatrix();
    glTranslatef(7 * base, (base + betw_height) + (5 * ground_offset), 3.489 * base);
    glScalef(2, 2, 2);
    draw_lightning();
    glPopMatrix();
    ...
    glPushMatrix();
    red;
    glTranslatef(3 * base, (base + betw_height) + (5 * ground_offset), 3.5 * base);
    glRotatef(90, 0, 1, 0);
    glScalef(1, 5, 3);
    drawCube(1, 5, 5);
    glPopMatrix();
    ...
    // raio
    glPushMatrix();
    glTranslatef(3 * base, (base + betw_height) + (5 * ground_offset), 3.489 * base);
    glScalef(2, 2, 2);
    draw_lightning();
    glPopMatrix();
